...
static bool test_range_constructor(void) {
	...
	if (*m2.begin() != *m1.begin() ||*++m2.begin() != *++m1.begin() ||*--m2.end() != *--m1.end())
		return (false);
	return (true);
}
...
static bool test_get_allocator(void) {
	...
	NS::set< NS::pair< std::string, int> >::allocator_type const alloc = m.get_allocator();
...
static bool test_rbegin(void) {
	...
	m.insert(NS::make_pair< std::string, int >("b", 2));
	m.insert(NS::make_pair< std::string, int >("c", 3));
	NS::set< NS::pair< std::string, int> >::reverse_iterator rbegin = m.rbegin();
...
static bool test_const_rbegin(void) {
	...
	m.insert(NS::make_pair< int, int >(3, 3));
	NS::set<NS::pair<int, int> > const					m_const(m.begin(), m.end());
	NS::set<NS::pair<int, int> >::const_reverse_iterator it = m_const.rbegin();
...
static bool test_const_rend(void) {
	...
	m.insert(NS::make_pair< int, int >(3, 3));
	NS::set<NS::pair<int, int> > const					m_const(m.begin(), m.end());
	NS::set<NS::pair<int, int> >::const_reverse_iterator itrend = m_const.rend();
	--itrend;
...
static bool test_swap(void) {
	...
	m1.swap(m2);
	if (*m1.begin() != *oldm2.begin() || *++m1.begin() != *++oldm2.begin() ||*--m1.end() != *--oldm2.end())
		return (false);
	if (*m2.begin() != *oldm1.begin() || *++m2.begin() != *++oldm1.begin() ||*--m2.end() != *--oldm1.end())
		return (false);
	return (true);
}
...
static bool test_count(void) {
	...
	m.insert(NS::make_pair< int, int >(3, 3));
	m.insert(NS::make_pair< int, int >(3, 3));
	if (m.count(NS::make_pair< int, int >(2, 2)) != 1 || m.count(NS::make_pair< int, int >(12, 12)) != 0 || m.count(NS::make_pair< int, int >(3, 3)) != 1)
		return (false);
	return (true);
}
static bool test_find(void) {
	...
	m.insert(NS::make_pair< int, int >(2, 2));
	m.insert(NS::make_pair< int, int >(3, 3));
	NS::set< NS::pair< int, int > >::iterator it = m.find(NS::make_pair< int, int >(1, 1));
	if (it->second != 1)
		return (false);
...
static bool test_const_find(void) {
	...
	m.insert(NS::make_pair< int, int >(2, 2));
	m.insert(NS::make_pair< int, int >(3, 3));
	NS::set<NS::pair<int, int> >::iterator const it = m.find(NS::make_pair< int, int >(1, 1));
	if (it->second != 1)
		return (false);
	NS::set<NS::pair<int, int> >::iterator const it2 = m.find(NS::make_pair< int, int >(2, 2));
	if (it2->second != 2)
		return (false);
	NS::set<NS::pair< int, int> >::iterator const it3 = m.find(NS::make_pair< int, int >(3, 3));
	if (it3->second != 3)
		return (false);
	return (true);
}
static bool test_equal_range(void) {
	...
	m.insert(NS::make_pair< int, int >(2, 2));
	m.insert(NS::make_pair< int, int >(3, 3));
	NS::pair< NS::set< NS::pair< int, int > >::iterator, NS::set< NS::pair< int, int > >::iterator > p;
...
static bool test_const_equal_range(void) {
	...
	NS::pair< NS::set< NS::pair< int, int > >::const_iterator,
			  NS::set< NS::pair< int, int > >::const_iterator > p;
	p									   = m.equal_range(NS::make_pair< int, int >(2, 2));
...
static bool test_lower_bound(void) {
	...
	m.insert(NS::make_pair< int, int >(2, 2));
	m.insert(NS::make_pair< int, int >(3, 3));
	NS::set< NS::pair< int, int > >::iterator it = m.lower_bound(NS::make_pair< int, int >(2, 2));
	if (it->first != 2 || it->second != 2)
		return (false);
	return (true);
}
static bool test_const_lower_bound(void) {
	...
	m.insert(NS::make_pair< int, int >(2, 2));
	m.insert(NS::make_pair< int, int >(3, 3));
	NS::set< NS::pair<int, int>  >::const_iterator it = m.lower_bound(NS::make_pair< int, int >(2, 2));
	if (it->first != 2 || it->second != 2)
		return (false);
	return (true);
}
static bool test_upper_bound(void) {
	...
	m.insert(NS::make_pair< int, int >(2, 2));
	m.insert(NS::make_pair< int, int >(3, 3));
	NS::set< NS::pair<int, int> >::iterator it = m.upper_bound(NS::make_pair< int, int >(2, 2));
	if (it->first != 3 || it->second != 3)
		return (false);
	return (true);
}
static bool test_const_upper_bound(void) {
	...
	m.insert(NS::make_pair< int, int >(2, 2));
	m.insert(NS::make_pair< int, int >(3, 3));
	NS::set< NS::pair<int, int> >::const_iterator it = m.upper_bound(NS::make_pair< int, int >(2, 2));
	if (it->first != 3 || it->second != 3)
		return (false);
	return (true);
}
