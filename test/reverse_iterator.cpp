...
bool test_reverse_iterator(void) {
	...
	t.registerTest("Non member operator == false", &test_nm_operator_equal_false);
	t.registerTest("Non member operator != true", &test_nm_operator_different_true);
	t.registerTest("Non member operator != false", &test_nm_operator_different_false);
	...
	t.registerTest("Non member operator <= true", &test_nm_operator_less_equal_true);
	t.registerTest("Non member operator <= false", &test_nm_operator_less_equal_false);
	t.registerTest("Non member operator > true", &test_nm_operator_great_true);
	t.registerTest("Non member operator > false", &test_nm_operator_great_false);
	t.registerTest("Non member operator >= true", &test_nm_operator_great_equal_true);
	t.registerTest("Non member operator >= false", &test_nm_operator_great_equal_false);
	return (t.run());
}
